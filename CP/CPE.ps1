...
#Spiel
Write-Host "Auswahl:"
Write-Host "[1] 1233" -ForegroundColor Yellow
Write-Host "[2] 1288" -ForegroundColor Yellow
Write-Host "[3] 1111" -ForegroundColor Yellow
do {
...
Write-Host "Auswahl:"
Write-Host "[1] 69420" -ForegroundColor Yellow
Write-Host "[2] 32400" -ForegroundColor Yellow
Write-Host "[3] 40202" -ForegroundColor Yellow
do {
...
Write-Host "Auswahl:"
Write-Host "[1] 235" -ForegroundColor Yellow
Write-Host "[2] 57" -ForegroundColor Yellow
Write-Host "[3] 382" -ForegroundColor Yellow
do {
...
Write-Host "System: force loading Flagge" -ForegroundColor Red
        sleep (4)
        Start-Process powershell.exe -ArgumentList "-File .\Teknet\Flagge\FE.ps1" -NoNewWindow -Wait
