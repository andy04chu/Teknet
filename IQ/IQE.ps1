...
#Spiel
Write-Host "Auswahl:"
Write-Host "[1] 13" -ForegroundColor Yellow
Write-Host "[2] 12" -ForegroundColor Yellow
Write-Host "[3] 14" -ForegroundColor Yellow
do {
...
Write-Host "Auswahl:"
Write-Host "[1] U" -ForegroundColor Yellow
Write-Host "[2] A" -ForegroundColor Yellow
Write-Host "[3] F" -ForegroundColor Yellow
do {
...
Write-Host "2 ? 6"
Write-Host "Auswahl:"
Write-Host "[1] 2" -ForegroundColor Yellow
Write-Host "[2] 4" -ForegroundColor Yellow
Write-Host "[3] 1" -ForegroundColor Yellow
do {
...
$Input2 = Read-Host -Prompt "Ready? (Enter druecken)"
        sleep (2.5)
        Start-Process powershell.exe -ArgumentList "-File .\Teknet\SSP\SSPE.ps1" -NoNewWindow -Wait